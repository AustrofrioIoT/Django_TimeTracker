...
class UserCreationForm(ModelForm):
    ...
    province = forms.CharField(widget=forms.TextInput, required=False)
    ...
    class Meta:
        model = User
        fields = ('email', 'password1', 'password2', 'first_name', 'last_name', 'direction', 'province', 'country', 'telephone', 'avatar')
